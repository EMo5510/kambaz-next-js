   ...
   <Table striped>
    ...
    <tbody>
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-login-id">001289961S</td>
      <td className="wd-section">S101</td>
      <td className="wd-role">STUDENT</td>
      ...
      <td className="wd-login-id">005541561S</td>
      <td className="wd-section">S101</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2020-10-01</td>
      ...
      <td className="wd-login-id">001234881S</td>
      <td className="wd-section">S101</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2020-24-01</td>
